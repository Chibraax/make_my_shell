...
# Copy theme files (Use LOGNAME because is POSIX)
curl -sSL $CONFIG_1 >/home/$LOGNAME/.oh-my-zsh/themes/chibraax1.zsh-theme
curl -sSL $CONFIG_2 >/home/$LOGNAME/.oh-my-zsh/themes/chibraax2.zsh-theme
